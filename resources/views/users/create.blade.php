                            ...
                            <div class="p-0">
                                <form action="{{ url('/users/confirm') }}" method="POST" enctype="multipart/form-data" accept='image/jpeg , image/jpg, image/gif, image/png'>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="phone_number" type="text" class="form-control form-control-user" value="{{ old('phone') }}" id="phone_number" placeholder="Phone Number">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="date_of_birth" class="col-sm-3 col-form-label">Date of Birth</label>
                                        <div class="col-sm-9">
                                            <input name="date_of_birth" type="date" value="{{ old('dob') }}" class="form-control form-control-user" id="date_of_birth" placeholder="Date of Birth">
                                        </div>
                                    </div>
                                    <div class="form-group row">
