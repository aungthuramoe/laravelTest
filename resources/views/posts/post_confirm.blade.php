                    ...
                    <form action="/posts/store" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10 col-lg-4">
                                <button type="submit" value="cancel" name="status" class="btn btn-primary  form-control text-uppercase">Cancel Post</i></button>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10 col-lg-4">
                                <button type="submit" value="create" name="status" class="btn form-control btn-success text-uppercase">Create Post</i></button>
                            </div>
                        </div>
                    </form>
                </div>
